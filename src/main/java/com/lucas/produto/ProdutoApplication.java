...
import com.lucas.produto.repositories.ProductRepository;
...
public class ProdutoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(2L,"Dmain Driven Design",120.00,cat2);
		Product p3 = new Product(3L,"PS5",2800.00,cat1);
		Product p4 = new Product(4L,"Docker",100.00,cat1);
